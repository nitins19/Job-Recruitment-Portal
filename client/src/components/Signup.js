...
const[user,setUser]=useState({
  name:"",email:"",phone:"",work:"",location:"",password:"",cpassword:""});
  ...
  {
    e.preventDefault();
    const {name,email,phone,work,location,password,cpassword}=user;
    const res=await fetch("/register",{
      method:"POST",
      headers:{
        "Content-Type":"application/json"
      },
      body:JSON.stringify({name,email,phone,work,location,password,cpassword})
    });
 ...
 <input type="text" name="work" id="work" autoComplete="off" value={user.work} onChange={handleInput} placeholder="Profession"/>
 ...
 <input type="text" name="location" id="location" autoComplete="off" value={user.location} onChange={handleInput} placeholder="Location"/>
